...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) { 
            //reset button 
            firstCountry.setSelectedIndex(0);//first dropdown reset
            secondCountry.setSelectedIndex(0);//second dropdown reset
            t1.setText("");//clears t1 textfield
            t2.setText("");//clears t2 textfield
        }
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            double amountChanged=0.0;//result
            double amountInPounds=0.0;//1 british pound value
